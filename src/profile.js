...
const about = {
  paragraph:
    "Web Developer who loves to create and weave connections. Graduated from PDX Code Guild Python Bootcamp, and continues to learn and be exposed to new concepts. One year experience developing and creating using JS and Python frameworks. Excited and motivated engineer ready and willing to work on new and existing projects!",
};
